...
trait Dropin
{
    ...
    /**
     * Returns true if the object cache is disabled via constant or environment variable.
     *
     * @return bool
     */
    ...
    public function applyFileModFilters($file_mod_allowed, $context)
    {
        if ($context === 'object_cache_dropin') {
             ...
             */
            return (bool) apply_filters('objectcache_allow_dropin_mod', $file_mod_allowed);
        }
