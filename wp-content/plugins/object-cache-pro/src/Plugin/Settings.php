...
trait Settings
{
    ...
    public function bootSettings()
    {
        ...
        add_action('rest_api_init', [new Api\Commands, 'register_routes']);
        ...
        add_action('rest_api_init', [new Api\Relay, 'register_routes']);
        add_action('rest_api_init', [new Api\Slowlog, 'register_routes']);
