...
<main id="primary" class="site-main saved-articles-page" data-saved-articles-page>
	<div class="<?php echo esc_attr( echorouk_container_class() ); ?>">
		...
		<header class="archive-header saved-articles-header">
			<h1 class="archive-title"><?php esc_html_e( 'Saved articles', 'echoroukonline' ); ?></h1>
			<p class="archive-description"><?php esc_html_e( 'Articles you saved will appear here.', 'echoroukonline' ); ?></p>
		</header>

		<section class="saved-articles-list-wrap" data-remove-label="<?php echo esc_attr__( 'Remove', 'echoroukonline' ); ?>">
