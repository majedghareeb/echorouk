(function () {
  ...
  function initShareDropdowns() {
    ...
    function placeMenu(dropdown, menu) {
      if (!dropdown || !menu) {
        return;
      }
      ...
      var spaceToRight = viewportWidth - dropdownRect.left;
      var spaceToLeft = dropdownRect.right;
