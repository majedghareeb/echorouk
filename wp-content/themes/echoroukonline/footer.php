        ...
        <div class="echorouk-footer-shell">
            <div class="echorouk-footer-main">
                ...
                <div class="row g-4">
                    ...
                    <section class="col-12 col-lg-3 echorouk-footer-col echorouk-footer-about">
                    ...
                    <section class="col-12 col-lg-3 echorouk-footer-col echorouk-footer-sections">
                        <?php
                    ...
                    <section class="col-12 col-lg-6 echorouk-footer-col">
                        <div class="echorouk-footer-contact">
                            ...
                            <p>
                                ...
                                <?php if ($footer_contact_email) : ?>
                                    <a
                                        href="mailto:<?php echo esc_attr($footer_contact_email); ?>"><?php echo esc_html($footer_contact_email); ?></a>
                                <?php endif; ?>
                            </p>
                        </div>
                ...
                <div class="row g-4">
                    <div class="col-12 col-lg-3 echorouk-footer-col"></div>
                    <div class="col-12 col-lg-3 echorouk-footer-col"></div>
                    <div class="col-12 col-lg-6 echorouk-footer-col">
