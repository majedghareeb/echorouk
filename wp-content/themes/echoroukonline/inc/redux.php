	...
	Redux::set_section(
		...
		array(
			...
			'fields' => array(
				...
				array( 'id' => 'echorouk_primary_color', 'type' => 'color', 'title' => esc_html__( 'Theme Primary Color', 'echoroukonline' ), 'default' => '#b42318', 'validate' => 'color' ),
	...
	Redux::set_section(
		...
		array(
			...
			'fields' => array(
				...
				array( 'id' => 'newsletter_title', 'type' => 'text', 'title' => esc_html__( 'Newsletter title', 'echoroukonline' ), 'default' => 'النشرة البريدية' ),
				array( 'id' => 'newsletter_intro', 'type' => 'textarea', 'title' => esc_html__( 'Newsletter intro text', 'echoroukonline' ), 'default' => 'تقدم الشروق خدمة إخبارية حصرية لمشتركي القائمة البريدية، ستصلك أخبارنا وتحليلاتنا وأخبارنا العاجلة أولا بأول لحظة وقوعها. اشترك في القائمة البريدية الآن' ),
				array( 'id' => 'newsletter_disclaimer', 'type' => 'textarea', 'title' => esc_html__( 'Newsletter disclaimer text', 'echoroukonline' ), 'default' => 'يرجى العلم أن الاشتراك في قائمتنا البريدية يعني الموافقة على الشروط والأحكام المتعلقة بمعالجة البيانات الشخصية' ),
				array( 'id' => 'newsletter_placeholder', 'type' => 'text', 'title' => esc_html__( 'Newsletter email placeholder', 'echoroukonline' ), 'default' => 'أدخل بريدك الإلكتروني هنا' ),
				array( 'id' => 'newsletter_button_label', 'type' => 'text', 'title' => esc_html__( 'Newsletter button label', 'echoroukonline' ), 'default' => '+' ),
